url = input("Enter the URL you wish the list of the other urls to be retrieved from, THEY MUST BE THE ENDPOINT FOR DOWNLOADS AND HAVE NO REDIRECTS: ")
name = input("Whats the name of your program? ")
with open("WInstall", "w+") as file:
    file.write(f"""
...
def download_all_files():
    a = requests.get("{url}")  # YOUR CONFIGURED MAIN LIST, CAN BE GITHUB RAW! ALSO CAN BE A FILE.
...
instruc = Label(root, text=f"Download {name}")
